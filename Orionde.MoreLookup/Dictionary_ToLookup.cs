...
namespace Orionde.MoreLookup
{
    ...
    public static class DictionaryExtensions
    {
        ...
        /// <param name="comparer">
        ///     An <see cref="IEqualityComparer{T}" /> to compare keys. If null, the default equality comparer
        ///     is used.
        /// </param>
        ...
        public static ILookup<TKey, TValue> ToLookup<TKey, TValue>(
            this IDictionary<TKey, IEnumerable<TValue>> dictionary, IEqualityComparer<TKey> comparer = null)
        {
        ...
        [Pure]
        public static ILookup<TKey, TValue> ToLookup<TKey, TValue>(
            this IDictionary<TKey, ICollection<TValue>> dictionary, IEqualityComparer<TKey> comparer = null)
        {
        ...
        internal static ILookup<TKey, TValue> ToLookup<TKey, TValue>(
        ...
        private static ILookup<TKey, TValue> ToLookup<TKey, TCollection, TValue>(
            this IEnumerable<KeyValuePair<TKey, TCollection>> dictionary, IEqualityComparer<TKey> comparer = null)
