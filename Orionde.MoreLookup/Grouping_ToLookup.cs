...
{
    /// <summary>
    ///     Provides extension methods for converting <see cref="IGrouping{TKey, TValue}" /> collections to
    ///     <see cref="ILookup{TKey, TValue}" /> instances.
    /// </summary>
    public static class GroupingExtensions
    {
        /// <summary>
        ///     Converts a collection of <see cref="IGrouping{TKey, TValue}" /> instances to an
