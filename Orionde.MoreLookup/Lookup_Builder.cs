...
namespace Orionde.MoreLookup
{
    ...
    public static partial class Lookup
    {
        ...
        /// <summary>
        /// Provides a fluent interface for building <see cref="ILookup{TKey, TValue}"/> instances with a specific key type and comparer.
        /// </summary>
        /// <typeparam name="TKey">The type of the keys in the lookup.</typeparam>
        ...
        /// <summary>
        /// Provides a fluent interface for building <see cref="ILookup{TKey, TValue}"/> instances with specific key and value types.
        /// </summary>
        /// <typeparam name="TKey">The type of the keys in the lookup.</typeparam>
        /// <typeparam name="TValue">The type of the values in the lookup.</typeparam>
        public class LookupBuilder<TKey, TValue>
        {
            ...
            /// <summary>
            /// Adds a key-value collection pair to the lookup being built. If the key already exists, the new values replace the previous ones.
            /// </summary>
            /// <param name="key">The key to associate with the values. Can be null for reference types.</param>
            /// <param name="values">The collection of values to associate with the key. If null, the key will not be included in the final lookup.</param>
