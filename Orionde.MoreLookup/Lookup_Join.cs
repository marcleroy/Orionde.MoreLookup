...
namespace Orionde.MoreLookup
{
    public static partial class LookupExtensions
    {
        ...
        ///     This method performs an inner join on the keys, combining values from both lookups using the specified result
        ///     selector.
        /// </summary>
        ...
        /// </param>
        /// <returns>
        ///     An <see cref="ILookup{TKey, TValue}" /> that has elements of type <typeparamref name="TResult" /> that are
        ///     obtained by performing an inner join on two lookups.
        /// </returns>
        /// <exception cref="ArgumentNullException">
        ///     <paramref name="outer" />, <paramref name="inner" />, or
