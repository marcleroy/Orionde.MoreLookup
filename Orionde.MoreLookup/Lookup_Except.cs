...
namespace Orionde.MoreLookup
{
    public static partial class LookupExtensions
    {
        ...
        ///     Values for keys in the first lookup are returned, excluding any values that also appear in the second lookup for
        ///     the same key.
        /// </summary>
        ...
        /// <param name="first">
        ///     An <see cref="ILookup{TKey, TValue}" /> whose elements that are not also in
        ///     <paramref name="second" /> will be returned.
        /// </param>
        /// <param name="second">
        ///     An <see cref="ILookup{TKey, TValue}" /> whose elements that also occur in the first lookup will
