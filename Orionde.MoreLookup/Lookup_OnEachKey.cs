...
namespace Orionde.MoreLookup
{
    public static partial class LookupExtensions
    {
        ...
        ///     A transform function to apply to each grouping. The function receives an
        ///     <see cref="IGrouping{TKey, TValue}" /> and returns an <see cref="IEnumerable{T}" /> of results.
        /// </param>
        /// <returns>
        ///     An <see cref="ILookup{TKey, TValue}" /> whose values are the result of invoking the transform function on each
        ///     grouping of the source lookup.
        /// </returns>
