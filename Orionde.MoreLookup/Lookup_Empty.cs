...
namespace Orionde.MoreLookup
{
    ...
    {
        /// <summary>
        ///     Returns an empty <see cref="ILookup{TKey, TValue}" /> instance. This method uses a singleton pattern to ensure the
        ///     same instance is returned for each type combination.
        /// </summary>
