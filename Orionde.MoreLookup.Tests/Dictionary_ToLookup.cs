...
namespace Tests
{
    ...
    public static class ShouldExtensionMethods
    {
        ...
        [AssertionMethod]
        public static void ShouldBeOfType([AssertionCondition(AssertionConditionType.IS_FALSE)] this bool condition)
        {
            if (condition)
            {
        ...
        [AssertionMethod]
        public static void ShouldBeOfType<T>([AssertionCondition(AssertionConditionType.IS_FALSE)] this object condition)
        {
            if (condition is T)
            {
                return;
            ...
            {
                throw new SpecificationException("Should be of type [" + typeof(T).Name + "] but is [" + condition.GetType().Name + "]");
            }
