...
public class LookupConcatTests
{
    ...
    public void When_concatenating_lookups_should_create_lookup_with_concatenated_values()
    {
        ...
        // Act
        ILookup<int, string>? concatenated = lookup.Concat(Lookup.LookupBuilder.WithKey(2, new[] { "e", "d" })
    ...
    public void When_concatenating_lookups_with_key_comparer_should_respect_comparer()
    {
        ...
        // Act
        ILookup<string, string>? concatenated = lookup.Concat(Lookup.LookupBuilder.WithKey("two", new[] { "b", "c" })
    ...
    public void When_concatenating_null_with_lookup_should_throw_ArgumentNullException()
    {
        ...
        // Act & Assert
        ArgumentNullException exception = Assert.Throws<ArgumentNullException>(() => lookup.Concat(Lookup.LookupBuilder.WithKey(2, new[] { "e", "d" })
            .WithKey(3, new[] { "f", "g" }).Build()));
    ...
    public void When_concatenating_lookup_with_null_should_throw_ArgumentNullException()
    {
        ...
        // Act & Assert
        ArgumentNullException exception = Assert.Throws<ArgumentNullException>(() => lookup.Concat(null));
        exception.Should().BeOfType<ArgumentNullException>();
    }
}