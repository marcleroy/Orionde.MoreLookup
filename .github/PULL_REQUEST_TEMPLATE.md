...
- [ ] Updated XML documentation comments for public APIs
- [ ] Updated README.md (if applicable)
- [ ] Updated CHANGELOG.md under "Unreleased" section
- [ ] Added code examples (if new feature)
...
<!-- Add screenshots if the changes include visual elements or examples -->
